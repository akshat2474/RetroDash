                    ...
                    builder: (context, child) {
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: Colors.cyanAccent.withOpacity(0.2 * _titleGlow.value),
                      ...
                      child: _showOptions
                          ? Column(
                              children: [
                                ...
                                _buildOptionButton('NEW GAME', Colors.greenAccent),
                                const SizedBox(height: 10),
                                _buildOptionButton('CONTINUE', Colors.amberAccent),
                                const SizedBox(height: 10),
                                _buildOptionButton('SETTINGS', Colors.blueAccent),
                              ],
                            )
                          : null,
                    ),
